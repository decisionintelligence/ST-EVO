...
from STEVO.llm import VisualLLMRegistry
from STEVO.utils.log import logger
...
class VideoReader(Reader):
    def parse(self, file_path: Path, task: str = "Describe this image as detail as possible.", frame_interval: int = 30,
              used_audio: bool = True) -> list:
